      ...
      <div className="footer__wrapper">
         <div className="footer__top">
            ...
            <div className="footer__list">
               <ul>
                  <li className="footer__list__link">Haqqımızda</li>
                  <li className="footer__list__link">Qanunvericilik</li>
                  <li className="footer__list__link">Xidmətlər</li>
                  <li className="footer__list__link">Məqalələr</li>
                  <li className="footer__list__link">Vakansiyalar</li>
                  <li className="footer__list__link">Əlaqə</li>
               </ul>
            </div>
